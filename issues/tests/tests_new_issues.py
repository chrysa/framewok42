...
class NewIssuesTestsLog(TestCase):
...
# create new issue user
# create new issue wrong user
# create new issue admin
# create new issue staff
# create new issue error title
# create new issue error message
# create new issue error title and message

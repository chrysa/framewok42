    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(choices=[('open', 'open'), ('progress', 'in_progress'), ('close', 'status')], max_length=20, default='open')),
                ('Assign', models.ForeignKey(related_name='assign', null=True, to=settings.AUTH_USER_MODEL)),

...
def gen_doc():
    ...
    if not os.path.isdir('doc'):
        ...
        result = open(file, 'r').read().replace("html_theme = 'alabaster'", "html_theme = 'classic'").replace("#html_title = None", "html_title = None").replace("#html_show_copyright = True", "html_show_copyright = True").replace("#html_last_updated_fmt = '%b %d, %Y'", "html_last_updated_fmt = '%b %d, %Y'").replace("#html_show_sourcelink = True", "html_show_sourcelink = True")
